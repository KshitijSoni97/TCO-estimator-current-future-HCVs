...
VehicleDefine = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\Input_Definition_File.xlsx');
...
GBXDefine = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\Basic_GBXDef.xlsx');
GNo = GBXDefine(:,1);
GRa = GBXDefine(:,2);
etaGRa = GBXDefine(:,3);
...
GLoss = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\All Gears.csv');
[GearNo,GInprpm,GInpTor,GTorLoss] = GearLossMap(GLoss);

%% ICE - BSFC and Throttle Map
clc
ThrottleMap = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\Throttle Torque.xlsx');              % Upload throttle map
FCMap = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\FC_Map.xlsx');                             % Upload Fuel Consumption Map with same breakpoints
...
clc
TorCurRaw= xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\325kW.csv');
...
AxlLoss = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 7 - Class 5 tractor\AxlLoss.xlsx');
...
clc
ValDat = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Class 5 Engg\Class 5 all routes_LongHaul_1Hz.csv');
ValTime = ValDat(:,1);
ValDist = ValDat(:,3);
ValVel = ValDat(:,4);
ValTarg = ValDat(:,5);
...
FCvalgps = ValFC/3600;                                 % Calculate VECTO FC
...
% clc
% InpSpeed = 90;         % Maximum input vehicle speed in kmph
% InpSpeedmps = InpSpeed/3.6;                         % Input Speed in m/s 
...
%% Compare models
out1 = sim('Refined_Model_45_Autofactor.slx',20000);
% 
% %%
% PTOF = PTOF2;
% CF = CF2;
% out2 = sim('Refined_Model_45_Autofactor.slx',20000);
% 
% %____________________________________________________________________________________________________________________________________
