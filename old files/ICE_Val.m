...
% clc
% ValDat = xlsread('C:\Users\Kshitij\Desktop\Thesis docs\Code\Total Simulink  Model files\Vehicle 2 - Class 5 TnT\Class5_ tractor_Long_Haul+ES_1Hz.csv');
% ValTime = ValDat(:,1);
% ValDist = ValDat(:,3);
% ValVel = ValDat(:,4);
% ValTarg = ValDat(:,5);
...
% for i = 1:length(MaxSpeedProfile)
...
FCvecto_tot = sum(FCvalgps(1:300))/843;
disp(FCvecto_tot);
